package controllers.singlePlayer.cristobalv2;
...
import controllers.singlePlayer.cristobal.Explorar;
...
public class Agent extends AbstractPlayer {
    ...
    protected Explorar explorar; // EXPLORATION PART
    ...
    public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer)
    {
        ...
        explorar = new Explorar(); // EXPLORATION PART
    }
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        //while(bestMove<100)
        {
            ...
            for (int i: orden){
              ...
              explorar.comprobarPropiedades(stCopySim.getSo()); // EXPLORATION PART
              if (debug){
      ...
      // System.out.println(stCopySim.getSo().getGameScore()+" nuestro calculo -> "+stCopySim.getScore());
       ...
       if (debug){
        ...
        explorar.incrementarFinalizaExploracion(queueState.size() == 0); // EXPLORATION PART
        explorar.setMaxNumNodos(nodos); // EXPLORATION PART
...
// System.out.println(stCopySim.getSo().getGameScore()+" nuestro calculo -> "+stCopySim.getScore());
  ...
  public void result(StateObservation stateObservation, ElapsedCpuTimer elapsedCpuTimer)// EXPLORATION PART
  {
      explorar.explorarMuere(stateObservation);
      explorar.explorarConQuienMuere(stateObservation);
      explorar.printResults();
